...
<body>
    ...
    <header>
        <nav>
            <ol>
                <li class="navItem">
                    <a class="navLink" id="currentPage" href="index.php">H O M E</a>
                    <a class="navIcon" href="index.php"><i id="currentIcon" class="fa fa-home fa-3x" aria-hidden="true"></i></a>
                </li>
                <li class="navItem">
                    <?php
                    if (isset($_SESSION['username'])){
    ...
    <!-- ################################## -->
    <!-- # Container browse main sections #-->
    <!-- ################################## -->
    <section id="main_container">
        <?php
            if ($logged){
                $time = "afternoon ";
                if (date('H')<12 and date('H')>=5){
                    $time = "morning ";
                } else if (date('H')>=12){
                    $time = "afternoon ";
                } else if (date('H')>=20){
                ...
                echo '<h2>Good '. $time . $_SESSION['username'] . ' :) </h2>';
            }
        ?>


        <!-- Title with spacer -->
        <h1>Today's trending posts and discussions</h1>

        <!-- ################################## -->
        <!-- # Section for FIRST row of posts # -->
        <!-- ################################## -->
        <section class="posts_section" id="posts_section1">
        ...
        if ($logged){
            echo "
                <section id=\"new_post_wrapper\">
                    ...
                    <a id='new_post_icon' href='write_post.php'><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i></a>
                </section>";
        }
        ?>
    </section>
